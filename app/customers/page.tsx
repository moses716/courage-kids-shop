    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm px-6 py-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <h2 className="text-2xl font-bold text-gray-800">Customers - COURAGE KIDS SHOP</h2>
          <button
                ...
                <div key={customer.id} className="bg-white rounded-xl shadow p-5 hover:shadow-lg transition">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm font-medium flex items-center justify-center gap-1"
                    >
